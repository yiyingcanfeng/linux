...
MYSQL_RSYNC_UPSTREAM="rsync://mirrors.tuna.tsinghua.edu.cn/mysql/downloads/"
...
baseurl=https://mirrors.tuna.tsinghua.edu.cn/mysql/yum/mysql-connectors-community-el$elver
enabled=1

[mysql-tools-community-el${elver}]
name=MySQL Tools Community
#baseurl=http://repo.mysql.com/yum/mysql-tools-community/el/$elver/x86_64/
baseurl=https://mirrors.tuna.tsinghua.edu.cn/mysql/yum/mysql-tools-community-el$elver
enabled=1

[mysql56-community-el${elver}]
name=MySQL 5.6 Community Server
baseurl=http://repo.mysql.com/yum/mysql-5.6-community/el/$elver/x86_64/
baseurl=https://mirrors.tuna.tsinghua.edu.cn/mysql/yum/mysql56-community-el$elver
enabled=1

[mysql57-community-el${elver}]
name=MySQL 5.7 Community Server
#baseurl=http://repo.mysql.com/yum/mysql-5.7-community/el/$elver/x86_64/
baseurl=https://mirrors.tuna.tsinghua.edu.cn/mysql/yum/mysql57-community-el$elver
enabled=1

[mysql80-community-el${elver}]
name=MySQL 8.0 Community Server
#baseurl=http://repo.mysql.com/yum/mysql-8.0-community/el/$elver/x86_64/
baseurl=https://mirrors.tuna.tsinghua.edu.cn/mysql/yum/mysql80-community-el$elver
enabled=1
...
if [[ -z ${DRY_RUN:-} ]]; then
    param=""
	for repo_mysql in $(crudini --get $cfg |grep mysql); do
		param=${param}" -r "${repo_mysql}
	done
	reposync -c $cfg -d -p ${YUM_PATH} -e ${cache_dir} ${param}
